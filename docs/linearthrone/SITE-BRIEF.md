# LinearThrone Technologies — Corporate Site Brief
...
**LinearThrone Technologies** houses:
...
| Path | Purpose |
|------|---------|
| `/` | Brand landing — hero, vision, project gateways |
| `/unitview` | Product deep-dive — purpose, benefits, features, media |
| `/llmod` | Teaser hub |
| `/house-victoria` | Teaser hub |
| `/contact` | Contact + About Us |

## Visual direction

- Dark ink / charcoal field with cool cyan–teal signal color and restrained platinum/gold throne accents.
- Expressive display typography (not Inter/Roboto/Arial).
- Atmospheric backgrounds (grid, soft depth) — not flat fills.
...
3. **Unit benefits** — faster admit/discharge awareness, staffing load awareness, printable assignments, oncoming-shift prep.
4. **Capabilities** — board, census stats, clinical flags, shift boards, print layouts (screenshots + short clips).
...
Until real assets land, the site uses branded UI mock frames as stand-ins.
