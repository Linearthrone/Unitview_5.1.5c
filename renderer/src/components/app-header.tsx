...
import { 
    ...
    ClipboardSignature, HeartHandshake, Ban, Droplet, Archive, LogOut
} from 'lucide-react';
        ...
        <div className="w-full flex items-center justify-between h-full px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-6 h-full">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-8xl font-headline font-bold text-primary">{title}</h1>
                {unitName && (
                  <h2 className="text-5xl font-bold text-primary mt-2">{unitName}</h2>
                )}
                <p className="text-2xl text-muted-foreground font-semibold mt-3">{activePatientCount} Patients / {totalRoomCount} Rooms</p>
              </div>
            </div>
          ...
          <div className="flex items-center gap-4 h-full">
            ...
            <div className="flex items-center gap-2">
                {/* Leave Unit Button - Only show when in unit view */}
                {onLeaveUnit && (
                    <Button 
                        variant="destructive" 
                        onClick={onLeaveUnit}
                ...
                {/* Layout Dropdown - Only show when not in unit view */}
